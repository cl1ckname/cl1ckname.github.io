...
export default function Postscript() {
    ...
    return (!deleted) ? <>
            ...
            <p>
                <a style={{color: "red"}}>はぁ そう です か, はぁ そう です か?</a><img className="gif-emoji" src="/kaguya.png" alt="ha sodesuka?"/> fair enough, but not too offensive.
                But
                what can I do? I am 1,013 days old when I write this. So far, this is the best way
                to interact with the world that I have. This is already quite a lot, it seems to me.
                And damn. Probably someday I won't be a programmer. It's even intriguing.
            </p>
            <p className="marquee">
        ...
        <p>
            ...
            write
            if you found a <span style={{textDecoration: "underline dotted red"}}>mitsake</span> here or if you have any ideas about what is happening here. If you have a job, write
            too,
            I don't have a resume on <a href="https://linkedin.com/clickname">LinkedIn</a>, but isn't everything clear to you without further ado?). I also hope that
            you
            are watching this through a PC. Yes, now the world of mobile phones, and it would be possible to adapt
            everything, but you really lose a lot by giving up the <span style={{fontSize: "2em"}}>big screen</span>. So don't be lazy. And eat well, exercise,
            read books, watch movies <sub>and cartoons</sub> take care of the people around you. <mark>Live and don't die</mark>. <button>Ok,
            mom</button>
        </p>
}
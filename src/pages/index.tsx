    ...
    return <div>
        ...
        <div id="content" className="mw-body ve-init-mw-desktopArticleTarget-targetContainer" role="main">
            ...
            <div id="bodyContent" className="vector-body"><span className="mw-editsection mw-content-ltr ve-hide"
                        ...
                        <div id="mw-fr-revisiontag"
                            ...
                            <div id="mw-fr-revisiondetails-wrapper" style={{position: "relative"}}>
                                <div id="mw-fr-revisiondetails" className="flaggedrevs_short_details"
                                    ...
                                    версия страницы пока <a title="Википедия:Проверка статей/Пояснение для читателей">не
                ...
                <div id="mw-content-text" className="mw-body-content mw-content-ltr" lang="ru" dir="ltr">
                    ...
                    <span
                        ...
                        <figure className="mw-halign-left" typeof="mw:File/Thumb"><a
                            href="//commons.wikimedia.org/wiki/File:FouSouKa_Cover.jpg" className="mw-file-description"><img
                            src="//upload.wikimedia.org/wikipedia/commons/thumb/e/ef/FouSouKa_Cover.jpg/180px-FouSouKa_Cover.jpg"
                            decoding="async" width="180" height="289" className="mw-file-element" data-file-width="750"
                ...
                <div id="catlinks" className="catlinks" data-mw="interface">
                    ...
                    <div id="mw-hidden-catlinks" className="mw-hidden-catlinks mw-hidden-cats-hidden">Скрытые категории:
                        <ul>
                            ...
                            <li><a title="Категория:Страницы, использующие волшебные ссылки ISBN">Страницы, использующие
                    ...
                    <div className="vector-menu-content">
                        ...
                        <ul className="vector-menu-content-list">
                            <li id="t-whatlinkshere" className="mw-list-item"><a
                                title="Список всех страниц, ссылающихся на данную [alt-shift-j]" accessKey="j"><span>Ссылки сюда</span></a>
                            </li>
                            ...
                            <li id="t-permalink" className="mw-list-item"><a
                                ...
                                title="Постоянная ссылка на эту версию страницы"><span>Постоянная ссылка</span></a></li>
                ...
                <nav id="p-wikibase-otherprojects"
                    ...
                    <div className="vector-menu-content">
                        ...
                        <ul className="vector-menu-content-list">
                            ...
                            <li id="t-wikibase" className="mw-list-item wb-otherproject-link wb-otherproject-wikidata"
        ...
        <footer id="footer" className="mw-footer" role="contentinfo">
            <ul id="footer-info">
                ...
                <li id="footer-info-copyright">please do not try to sue me for licking the appearance and all the CSS
                    tables
